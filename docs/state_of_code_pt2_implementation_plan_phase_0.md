...
## Goal
Refactor ContainerClaw's codebase to be modular, idempotent, and stream-centric per the analysis in [state_of_code_pt1.md](file:///.../containerclaw/docs/state_of_code_pt1.md) and [state_of_code_pt2.md](file:///.../containerclaw/docs/state_of_code_pt2.md). Phased to allow testing between each phase.
...
#### [NEW] [schemas.py](file:///.../containerclaw/agent/src/schemas.py)
...
- Replace inline schema definitions in [init_infrastructure()](file:///.../containerclaw/agent/src/main.py#585-666) (lines 602-655) with imports from `schemas.py`
...
#### [MODIFY] [tools.py](file:///.../containerclaw/agent/src/tools.py)
...
#### [NEW] [fluss_client.py](file:///.../containerclaw/agent/src/fluss_client.py)
- `FlussClient` class encapsulating:
  - `connect()` — connection + retry logic currently in [init_infrastructure()](file:///.../containerclaw/agent/src/main.py#585-666)
  - `ensure_tables()` — create database + all 3 tables
  - `create_tailing_scanner(table, start_ts=None)` — dynamic bucket discovery via [get_table_info()](file:///.../containerclaw/fluss-rust/bindings/python/src/table.rs#662-666), timestamp seeking
  - Store `conn`, `admin`, `chat_table`, `sessions_table`, `board_table` as instance attributes

#### [MODIFY] [main.py](file:///.../containerclaw/agent/src/main.py)
- Replace [init_infrastructure()](file:///.../containerclaw/agent/src/main.py#585-666) function with `FlussClient.connect()` + `FlussClient.ensure_tables()`
...
#### [MODIFY] [moderator.py](file:///.../containerclaw/agent/src/moderator.py)
- `StageModerator.__init__()` takes `FlussClient` instead of [table](file:///.../containerclaw/fluss-rust/bindings/python/src/table.rs#739-755), `sessions_table`, `fluss_conn`
- [_replay_history()](file:///.../containerclaw/agent/src/moderator.py#383-456) uses `FlussClient.create_tailing_scanner()`
...
#### [NEW] [commands.py](file:///.../containerclaw/agent/src/commands.py)
...
#### [MODIFY] [moderator.py](file:///.../containerclaw/agent/src/moderator.py)
- Replace command parsing in [_handle_single_message()](file:///.../containerclaw/agent/src/moderator.py#457-504) (lines 477-491) with `CommandDispatcher.dispatch()`
